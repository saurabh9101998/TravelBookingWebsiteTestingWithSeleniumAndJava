...
//	JavascriptExecutor jse;
	...
	public void roundTripMethod(String keyword, String source, String destination, String departDate, String returnDate,
			String fname, String lname, String email, String mno, String emno) throws IOException {
		
		try
		{
			switch (keyword.toUpperCase()) {
			case "ROUNDTRIPSEARCHFLIGHT":
			homePage = new HomePage(driver);
			homePage.roundTripSearchFlight(driver, source, destination, departDate, returnDate, screenShotCapture,keyword);
			break;
...
//
//		Sheet sheet = file.readExcel(1);
//
//		int rowCount = sheet.getLastRowNum() - sheet.getFirstRowNum();
//		object = new Object[rowCount][10];
